...
?>
        <div class="container mx-auto mt-3">
            ...
            <div class="content-section col-md-9" id="section1">
                <form action="<?php echo htmlentities($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <input class="btn btn-primary px-5" type="submit" value="Save changes">
                </form>
            </div>
            ...
            <div class="content-section" id="section3">
                ...
                <form action="<?php echo htmlentities($_SERVER["PHP_SELF"]) ?>" method="post">
                    ...
                    <input class="btn btn-primary px-5" type="submit" value="Change Values">
                </form>
            </div>
        </div>
    ...
    ?>
        <div class="container mx-auto my-3">
            <p class="text-center">Here is the entire detail of <?php echo "teacher" . " " . $rollno; ?> </p>
            <hr>
            <div class="btn-group btn-group-md mb-3">
                <button type="button" data-section="section1" class="btn btn-primary segmentedButton" onclick="showing('section1')" id="btn1">personal information</button>
            ...
            <div class="content-section col-md-9" id="section1">
                <form action="<?php echo htmlentities($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="phone" id="phone" value="<?php echo (isset($_POST["people"]) || isset($_GET["success"]) ? $result["phone"] : (isset($_GET["phone"]) ? $_GET["phone"] : "")); ?>" required>
                        <?php
                        if (isset($_GET["error"]) && $_GET["error"] == '1') {
                        ?>
                            <p>Phone number must be 10 digit number</p>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="date" name="doj" id="doj" value="<?php echo (isset($_POST["people"]) || isset($_GET["success"]) ? $result["date_of_joining"] : (isset($_GET["doj"]) ? $_GET["doj"] : "")); ?>" required>
                    </div>
                    <div class="form-group">
                ...
                ?>
                    ...
                    <form action="<?php echo htmlentities($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="salarychange" id="salary" value="<?php echo (isset($_POST["people"]) || isset($_GET["success"])) ? $result1["actual_salary"] : (isset($_GET["salarychange"]) ? $_GET["salarychange"] : "");  ?>" onkeyup="cpscreator(this.value)" required>
                        </div>
                        <?php
                        if (isset($_GET["error"]) && $_GET["error"] == '1') {
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="month" name="implementmonth" id="implementmonth">
                        </div>
                        <div class="form-group">
                            <label for="cpscurrent">Current cps balance</label>
                            <input class="form-control" type="text" name="cpscurrent" id="cpscurrent" value="<?php echo $cps["cps"]; ?>" readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <input class="btn btn-primary px-5" type="submit" value="Assign salary changes">
                    </form>
                    <form action="<?php echo htmlentities($_SERVER["PHP_SELF"]); ?>" method="post">
                        <?php
                        ...
                        <input class="btn btn-primary px-5" type="submit" value="update paid details">
                    </form>
                ...
                ?>
                    ...
                    <form action="<?php echo htmlentities($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="actualsalary" id="actualsalary">
                        </div>
                        <input type="hidden" name="salary" value="asd425sws">
                        <input class="btn btn-primary px-5" type="submit" value="Assign Salary">
                    </form>
                <?php
                }
                ?>
            ...
            <div class="content-section" id="section3">
                ...
                $query1 = mysqli_query($conn, "SELECT * from class where rollno='$rollno';");
    ...
    if (isset($_GET["success"])) {
        ...
        <div style="margin-top: 200px;"><?php include_once '../footer.php' ?></div>
