                ...
                <div class="col">
                    <form action="<?php echo htmlentities($_SERVER["PHP_SELF"]) ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="subid" id="subid" pattern="^[0-9]{3}$" value="<?php echo isset($_GET["subid"]) ? $_GET["subid"] : "" ?>">
                        </div>
                        <div class="form-group">
                            <label for="subname">Subject name</label>
                            <input class="form-control" type="text" name="subname" id="subname" pattern="^[A-Z ]+$" value="<?php echo isset($_GET["subname"]) ? $_GET["subname"] : "" ?>">
                        </div>
                        <input class="btn btn-primary mt-3" type="submit" value="Add Subject">
                    </form>
                </div>
                <div class="col">
