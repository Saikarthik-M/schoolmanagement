...
?>
    ...
    <body>
        <h1>Fill the staff details</h1>
        <form action="<?php echo htmlentities($_SERVER["PHP_SELF"]) ?>" method="post">
            <div>
                <label for="name">Name (in capital with initial at end)</label>
                <input type="text" pattern="^[A-Z ]+$" name="name" id="name" value="<?php echo isset($_GET["name"]) ? $_GET["name"] : "" ?>" required>
                <?php
            ...
            <div>
                ...
                <input type="date" name="doj" id="doj" value="<?php echo isset($_GET["doj"]) ? $_GET["doj"] : "" ?>" required>
            </div>
            <div>
            ...
            <h6>NOTE : Password will be the ROLL NUMBER (in caps) , staffs can change it anytime they want</h6>
            <?php
