        ...
        <div class="container mx-auto mt-3">
            <form action="<?php echo htmlentities($_SERVER["PHP_SELF"]) ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="reason" id="reason" pattern="^[0-9a-zA-Z \/,.]{2,50}$" value="<?php echo isset($_GET["reason"]) ? $_GET["reason"] : "" ?>" required>
                    <?php
                ...
                <input class="btn btn-danger mt-3" type="submit" value="Remove teacher">
                <?php
