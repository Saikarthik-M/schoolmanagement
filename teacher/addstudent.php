            ...
            <div class="jumbotron ">
                <form action="<?php echo htmlentities($_SERVER["PHP_SELF"]); ?>" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" pattern="^[A-Z ]+$" id="name" value="<?php echo isset($_GET["name"]) ? $_GET["name"] : "" ?>" required>
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="rollno" pattern="^[A-Za-z0-9]+$" id="rollno" value="<?php echo isset($_GET["rollno"]) ? $_GET["rollno"] : "" ?>" required>
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="email" id="email" value="<?php echo isset($_GET["email"]) ? $_GET["email"] : "" ?>" required>
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="address" id="address" pattern="^[0-9a-zA-Z \/,.]{2,50}$" value="<?php echo isset($_GET["address"]) ? $_GET["address"] : "" ?>" required>
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="dob" id="dob" value="<?php echo isset($_GET["dob"]) ? $_GET["dob"] : "" ?>" required>
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="fathername" pattern="^[A-Z ]+$" id="fathername" value="<?php echo isset($_GET["fathername"]) ? $_GET["fathername"] : "" ?>" required>
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="mothername" pattern="^[A-Z ]+$" id="mothername" value="<?php echo isset($_GET["mothername"]) ? $_GET["mothername"] : "" ?>" required>
                        <?php
                        if (isset($_GET["error"]) && $_GET["error"] == '3') {
                        ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="fatherphone" pattern="^[0-9]{10}$" id="fatherphone" value="<?php echo isset($_GET["fatherphone"]) ? $_GET["fatherphone"] : "" ?>" required>
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="motherphone" pattern="^[0-9]{10}$" id="motherphone" value="<?php echo isset($_GET["motherphone"]) ? $_GET["motherphone"] : "" ?>" required>
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="fatheroccupation" pattern="^[a-zA-Z ]{1,30}$" id="fatheroccupation" value="<?php echo isset($_GET["fatheroccupation"]) ? $_GET["fatheroccupation"] : "" ?>" required>
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="motheroccupation" pattern="^[a-zA-Z ]{1,30}$" id="motheroccupation" value="<?php echo isset($_GET["motheroccupation"]) ? $_GET["motheroccupation"] : "" ?>" required>
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="birthcertificatenumber" pattern="^[0-9]{1,}$" id="birthcertificatenumber" value="<?php echo isset($_GET["birthcertificatenumber"]) ? $_GET["birthcertificatenumber"] : "" ?>" required>
                        <?php
